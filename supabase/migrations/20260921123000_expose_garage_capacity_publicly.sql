-- Expose Garage capacity through the public property API.
--
...
-- - property media
-- - public postal code
-- - Chalet structured data
-- - Office structured data
-- - address privacy rules
--
-- Garage-specific public data:
-- - garage_capacity
--
-- Sensitive/admin-only location data such as cadastral reference,
-- block and door remain private.
...
comment on function public.get_public_properties(text, boolean, integer) is
  'Read-only public property API. Returns published, reserved, sold and rented properties with SEO, media, Chalet, Office and Garage structured data. Address exposure follows exact, street_only or hidden privacy settings. Sensitive administrative address data remains private.';
