    ...
    <>
      ...
      <JsonLd
        data={{
          ...
          description: article.excerpt,
          publisher: { '@type': 'Organization', name: 'Alvar Consultores Inmobiliarios' },
        }}
      />
        ...
        <Container className="blog-post__layout">
          ...
          <div className="blog-post__content">
            ...
            <div className="article-cta">
              <p>¿Necesitas aplicar estas ideas a una operación concreta?</p>
              <Button to="/contacto">Hablar con un asesor</Button>
            </div>
            <Link to="/blog" className="back-link">← Volver al cuaderno inmobiliario</Link>
          </div>
        </Container>
      </article>
    </>
