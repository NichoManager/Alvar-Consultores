    ...
    <section className="hero">
      <Container className="hero__grid">
        <div className="hero__content">
          <p className="eyebrow hero-animate hero-animate--1">MADRID · PINTO · MÓSTOLES</p>
          ...
          <div className="hero__proof hero-animate hero-animate--5">
            <div><strong>5,0</strong><span aria-hidden="true">★★★★★</span><span className="sr-only">Cinco estrellas en Google</span><small>en Google · 12 reseñas</small></div>
            <div><strong>18+</strong><small>años de experiencia</small></div>
          </div>
        </div>
        <div className="hero__visual hero-animate hero-animate--image" aria-label="Composición editorial inspirada en arquitectura y territorio de Madrid" role="img">
          ...
          <div className="hero__blueprint" aria-hidden="true"><i /><i /><i /><i /></div>
          <div className="hero__territory" aria-hidden="true">
            ...
            <span className="hero__place hero__place--madrid"><i />Madrid</span>
            <span className="hero__place hero__place--pinto"><i />Pinto</span>
            <span className="hero__place hero__place--mostoles"><i />Móstoles</span>
          </div>
          <div className="hero__monogram" aria-hidden="true">A</div>
          <p className="hero__caption"><span>01 / 03</span> Consultoría inmobiliaria</p>
        </div>
      </Container>
    </section>
  );
